...
function LoadUI(Hub,Color)
    ...
    spawn(function()
        ...
        Frame:TweenSize(UDim2.new(0,222,0,13),"Out","Linear",10,true)
        wait(10)
        Loading.Text = "Loaded"
        wait(.8)
    ...
    Bar.BorderColor3 = Color
    Bar.Position = UDim2.new(0.301999986, 0, 0.419999987, 0)
    Bar.Size = UDim2.new(0, 100, 0, 1)

end

LoadUI('Makima Hub - Loader',Color3.fromRGB(255,0,0))

task.wait(11.2)

local camera = workspace.CurrentCamera
local blurAmount = 7
local blurAmplifier = 3
