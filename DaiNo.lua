...
return top
    ...
    function topos(Pos)
        ...
        function xTweenPosition:Stop()
                tween:Cancel()
                return tween
        endif r:DistanceFromCharacter(Pos.Position) <= 379 then 
            r.Character.HumanoidRootPart.CFrame = Pos
...
local Raids = Window:Taps("Raids")
local tp = Window:Taps("Teleport")
...
Main1:Line()
Main1:Label("Kaitan",10947338011)
...
Main1:Toggle("Auto Hook",false,function(value)
    getgenv().Hook = value
end)

Main1:Toggle("Auto",false,function(value)
    getgenv().wait = value
end)
...
local Item = Main2:Drop("Select","Items",false,Items,function(v)
   getgenv().Select = v
end)
...
Main2:Button("Load Select Item",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LoadItem",getgenv().Select)
end)
Main2:Button("Store Select Item",function()
    game.Players.localPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(555,444,555)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreItem",getgenv().Select)
end)
Main2:Line()
Main2:Label("Combat")
...
if World1 then
    local Go = tp2:Drop("Teleport","Select",false,{
        "WindMill";
        "Marine";
        "Middle Town";
        "Jungle";
        ...
        "Shank Room";
        "Mob Island";
        },function(v) getgenv().SelectIsland = v
        end)
elseif World2 then
    local Go = tp2:Drop("Teleport","Select",false,{
        "The Cafe";
...
tp2:Toggle("Teleport",false,function(value)
...
spawn(function()
    ...
    spawn(function()
        while wait() do
            pcall(function()
                if getgenv().Truetriple then
                        if not game.Players.LocalPlayer.Character.FindFirstChild("Saddi") or game.Players.LocalPlayer.Backpack.FindFirstChild("Saddi") then
                            game.GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LoadItem","Saddi")
                        elseif not game.Players.LocalPlayer.Character.FindFirstChild("Wando") or game.Players.LocalPlayer.Backpack.FindFirstChild("Wando") then
                            game.GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LoadItem","Wando")
                        elseif not game.Players.LocalPlayer.Character.FindFirstChild("Shisui") or game.Players.LocalPlayer.Backpack.FindFirstChild("Shisui") then
    ...
    Main1:Drop("Select Monster","Farm",false,tableMon, function(vu)
        SelectMonster = vu
    end)
    
    Main1:Toggle("Auto Farm Select Monster", false, function(vu)
       getgenv(). AutoFarmSelectMonster = vu
        if vu == false then
            wait(1)
        ...
        pcall(function()
            while wait() do
                if getgenv().AutoFarmSelectMonster then
                        CheckQuest()
                        pcall(function()
                            if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                        ...
                                        if v.Humanoid.Health > 0 then
                                            repeat game:GetService("RunService").Heartbeat:wait()
                                                if string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                                    AutoHaki() Click()
                                                    topos(v.HumanoidRootPart.CFrame * CFrame.new(20,20,0))
                                                    v.HumanoidRootPart.CanCollide = false
                                            ...
                                            until not getgenv().AutoFarmSelectMonster or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible
                                        end
                                    end
                                end
                            else
...
m1:Button("View Upgrade Sword",function()
    for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
        if v.ToolTip == "Sword" then
           if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
               local ToolSe = tostring(v.Name)
               local tool = game.Players.LocalPlayer.Backpack:FindFirstChild(ToolSe)
               game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("UpgradeItem","Check",ToolSe)
           end
        end
    end
end)

m1:Button("Upgrade Sword",function()
    for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("UpgradeItem","Upgrade",tostring(v.Name))
    end
end)

m1:Button("View Upgrade Gun",function()
    for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
        if v.ToolTip == "Gun" then
           if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
               local ToolSe = tostring(v.Name)
...
m1:Button("Upgrade Gun",function()
    for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
        if v.ToolTip == "Gun" then
           if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
               local ToolSe = tostring(v.Name)
               local tool = game.Players.LocalPlayer.Backpack:FindFirstChild(ToolSe)
               game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("UpgradeItem","Upgrade",ToolSe)
           end
        end
    end
end)
...
spawn(function()
    while wait(1) do
        pcall(function()
            if not isfolder('DaiNo Hub') then
                    makefolder('DaiNo Hub')
                end
                if not isfile('DaiNo Hub/Config.json') then
                    writefile('DaiNo Hub/Config.json',game:GetService("HttpService"):JSONEncode(getgenv().Config))
                end
                if isfolder('DaiNo Hub') and isfile('DaiNo Hub/Config.json') then
                    getgenv().Config = game:GetService("HttpService"):JSONDecode(readfile('DaiNo Hub/Config.json'))
            ...
            if isfolder('DaiNo Hub') and isfile('DaiNo Hub/Config.json') then
               ...
               if readfile('DaiNo Hub/Config.json') ~= getgenv().Config then
                   writefile('DaiNo Hub/Config.json',game:GetService("HttpService"):JSONEncode(getgenv().Config))
               end
            end
        end)
